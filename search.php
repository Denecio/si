...
<main class ="principal">
    ...
    <div class ="albuns">
        ...
        <div class = "album_individual">
            <img src ="" alt="Zuccenberg">
            <h3> Zeccenberg </h3>
            <h4> Tommy Cash </h4>
        </div>
        <div class = "album_individual">
            <img src ="" alt="Is This It">
            <h3> Is This It </h3>
            <h4> The Strokes </h4>
        </div>
        <div class = "album_individual">
            <img src ="" alt="Eu não pedi para ser português apenas tive sorte">
