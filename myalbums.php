...
<main class ="principal">
    ...
    <h1 class="texto_tit"> MY ALBUNS </h1>

    <form id="form">
        <input type="search" id="search" placeholder="Search...">
        <button> <img src="imagens/lupa.svg" alt="lupa"> </button>
    </form>
    ...
    <div class ="albuns">
        ...
        <div class = "album_individual">
            <img class="albIMG" src ="imagens/volume2.jpeg" alt="Eu não pedi para ser português apenas tive sorte">
            <h3> Eu não pedi para ser português apenas tive sorte </h3>
            <h4> M0$H dƐ BƎt*s </h4>
        </div>
        <div class = "album_individual">
        ...
        <div class = "album_individual">
            <img class="albIMG" src ="imagens/volume2.jpeg" alt="YHLQMDNLG">
            <h3> YHLQMDNLG </h3>
            <h4> Bad Bunny </h4>
        </div>
        <div class = "album_individual">
            <img class="albIMG" src ="imagens/volume2.jpeg" alt="La revancha del tango">
            <h3> La revancha del tango </h3>
            <h4> Gotan Project </h4>
        </div>
        <div class = "album_individual">
            <img class="albIMG" src ="imagens/volume2.jpeg" alt="Everything you have come to expect">
            <h3> Everything you have come to expect </h3>
            <h4> The Last Shadow Puppets </h4>
        </div>
        <div class = "album_individual">
            <img class="albIMG" src ="imagens/volume2.jpeg" alt="¥€$">
            <h3> ¥€$ </h3>
            <h4> Tommy Cash  </h4>
        </div>
        <div class = "album_individual">
            <img class="albIMG" src ="imagens/volume2.jpeg" alt="Igor">
            <h3> Igor </h3>
            <h4> Tyler, The Creator  </h4>
        </div>
        <div class = "album_individual">
            <img class="albIMG" src ="imagens/volume2.jpeg" alt="Ganda Moca">
            <h3> Ganda Moca </h3>
            <h4> Yuri Nr5  </h4>
        </div>
